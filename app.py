...
app.secret_key = os.environ.get('SECRET_KEY', 'civicfix_local_secret_key')
...
#     'user'    : 'root',
#     'password': 'civicfix123',  # ← matches docker-compose MYSQL_ROOT_PASSWORD
#     'database': 'civicfix',
#     'port'    : 3306
# }
...
#     'user'    : os.environ.get('MYSQL_USER',     'root'),
#     'password': os.environ.get('MYSQL_PASSWORD', 'civicfix123'),
#     'database': os.environ.get('MYSQL_DATABASE', 'civicfix'),
#     'port'    : int(os.environ.get('MYSQL_PORT', 3306))
# }
